  ...
  return (
    <div className="banner">
        ...
        <div className="banner-right">
            <Image src="https://cdn.dribbble.com/users/3251575/screenshots/18004988/media/d6a01e671362052896625a63b7a960bc.jpeg?compress=1&resize=1000x750&vertical=top" alt="" srcSet="" fallback={<Shimmer width={'100%'} height={'100%'} />} />
        </div>
